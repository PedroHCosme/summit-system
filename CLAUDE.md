# Summit System - Contexto para Claude
...
| Arquivo | Conteudo |
|---------|----------|
| `.claude/docs/BUSINESS_RULES.md` | Regras de negocio, tipos de plano, status de membro vs plano |
| `.claude/docs/ARCHITECTURE.md` | Mapa da codebase, camadas, dependencias entre arquivos |
| `.claude/docs/REPORTS_STATUS.md` | Estado atual dos relatorios, problemas conhecidos, roadmap |
| `.claude/docs/DATA_DICTIONARY.md` | Tabelas do banco, campos, tipos, relacionamentos |
